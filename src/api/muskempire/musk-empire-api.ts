...
import {HeroInfoResponse, LoadDbResponse, SkillsResponse} from "./model.js";
...
const loadDb = async (
  token: string
): Promise<AxiosResponse<LoadDbResponse>> =>
  axios.get(
	`${BASE_DOMAIN}/dbs`,
	{
	  headers: {
...
export {loadDb, skills, authByTelegramWebApp, getHeroInfo, improveSkill, claimOfflineBonus}